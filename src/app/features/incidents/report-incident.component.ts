...
@Component({
  ...
  styles: [`
    ...
    .field { display:flex; flex-direction:column; gap:.35rem; margin-bottom: .75rem; font-weight: 750; color: var(--text-primary); }
    ...
    .ok { padding: 10px 12px; background: rgba(63,185,80,.1); border: 1px solid rgba(63,185,80,.3); color: var(--accent); border-radius: 12px; margin-bottom: 1rem; }
  `],
})
