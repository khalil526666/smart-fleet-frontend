...
@Component({
  ...
  styles: [`
    ...
    input, select { border: 1px solid var(--border); border-radius: 10px; padding: .55rem .6rem; font: inherit; background: var(--bg-surface-2); color: var(--text-primary); }
    table { width:100%; border-collapse: collapse; }
    th, td { padding: 10px 12px; border-bottom: 1px solid var(--border); text-align:left; vertical-align: top; color: var(--text-primary); }
    ...
    .errtxt { color: var(--danger); margin-top: 4px; }
    .pill { display:inline-block; padding: 2px 8px; border-radius: 999px; font-size: 12px; background: var(--bg-surface-2); color: var(--text-secondary); text-transform: lowercase; }
    .pill.sent { background: rgba(63,185,80,.12); color: var(--accent); }
    .pill.failed { background: rgba(248,81,73,.12); color: var(--danger); }
    .pill.skipped { background: rgba(148,163,184,.1); color: var(--text-muted); }
