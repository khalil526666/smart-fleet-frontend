...
@Component({
  ...
  styles: [`
    ...
    .back { display:inline-block; margin-bottom: .75rem; color: var(--accent); font-weight:800; text-decoration:none; }
    .back:hover { color: var(--accent-hover); text-decoration: underline; }
    ...
    .btn { padding: 6px 10px; border: 1px solid var(--border); background: var(--bg-surface-2); color: var(--text-primary); border-radius: 10px; cursor: pointer; text-decoration:none; font-weight:700; }
    ...
    .card { background: var(--bg-surface); border: 1px solid var(--border); border-radius:16px; padding: 14px 16px; }
    .map-wrap { height: 320px; margin-top: .75rem; border-radius: 14px; overflow: hidden; border: 1px solid var(--border); }
    ...
    .trip-val { font-weight:800; font-size: 1.05rem; margin-top: .15rem; color: var(--text-primary); }
