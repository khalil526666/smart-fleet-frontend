...
@Component({
  ...
  styles: [`
    ...
    .chip.active { background: var(--accent); color: var(--bg-app); border-color: var(--accent); }
    .chip-critical { border-color: var(--danger); }
    .chip-medium { border-color: var(--warning); }
    ...
    .alert-row.critical { border-color: rgba(248,81,73,0.45); background: rgba(248,81,73,0.08); }
    .alert-row.medium { border-color: rgba(210,153,34,0.45); background: rgba(210,153,34,0.08); }
    .title { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.25rem; }
    .vehicle { color: var(--text-muted); font-size: 0.875rem; margin-bottom: 0.25rem; }
    .msg { color: var(--text-primary); }
    .time { color: var(--text-muted); font-size: 0.8125rem; text-align: right; white-space: nowrap; }
    .level-badge {
    ...
    .level-critical { background: rgba(248,81,73,0.18); color: #fc8181; }
    .level-medium { background: rgba(210,153,34,0.18); color: #fbbf24; }
    .level-info { background: rgba(63,185,80,0.15); color: var(--accent); }
